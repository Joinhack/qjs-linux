...
import {CPU_X86} from "cpux86-ta.js"
import {PIC_Controller} from "PIC.js"
import {PIT} from "PIT.js"
import {CMOS} from "CMOS.js"
import {Serial} from "Serial.js"
import {KBD} from "KBD.js"
import {clipboard_device} from "clipboard.js"
...
export function PCEmulator(params) {
    var cpu;
    cpu = new CPU_X86();
    this.cpu = cpu;
...
PCEmulator.prototype.start = function() { os.setTimeout(this.timer_func.bind(this), 10); };
...
PCEmulator.prototype.timer_func = function() {
    ...
    if (!do_reset) {
        if (err_on_exit) {
            os.setTimeout(this.timer_func.bind(this), 10);
        } else {
            os.setTimeout(this.timer_func.bind(this), 0);
        }
    }
};
